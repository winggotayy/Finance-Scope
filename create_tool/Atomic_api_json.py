...
atomic_api = {
    ...
    "Column_name": None,
    "example_input": None,
    "output_first_and_last_row": None,
}
atomic_api["func_desc"] = "财务指标"
atomic_api["Column_name"] = columns_dict
atomic_api["example_input"] = (
    'pro.fina_indicator(ts_code = "600000.SH",start_date = "20200104",end_date = "20220104",fields=["ts_code","end_date","eps","current_ratio","quick_ratio","inv_turn","netprofit_margin","grossprofit_margin","roe","roa","roic","debt_to_assets","netprofit_yoy","dt_netprofit_yoy"])'
)
...
atomic_api["Column_name"] = columns_dict
atomic_api["example_input"] = (
    'pro.stock_company(ts_code = \'600230.SH\', fields=["ts_code","exchange","chairman", "manager","secretary", "reg_capital","setup_date", "province","city","introduction","website", "email","office","employees","main_business","business_scope"])'
)
atomic_api["output_first_and_last_row"] = df_sample_str
...
atomic_api["Column_name"] = columns_dict
atomic_api["example_input"] = (
    'pro.daily_basic(ts_code = "600230.SH",start_date = "20180726",end_date = "20200726", fields=["ts_code", "trade_date","turnover_rate","turnover_rate_f","volume_ratio","pe_ttm","pb","ps_ttm","dv_ttm","total_share","float_share","free_share","total_mv","circ_mv"])'
)
...
atomic_api["example_input"] = (
    'pro.stk_factor(ts_code=stock_code,start_date= start_date,end_date= end_date,fields=["ts_code","trade_date","close","macd_dif","macd_dea","macd","kdj_k","kdj_d","kdj_j","rsi_6","rsi_12","rsi_24","boll_upper","boll_mid","boll_lower","cci"])'
)
atomic_api["output_first_and_last_row"] = df_sample_str
...
atomic_api["example_input"] = (
    'pro.moneyflow_hsgt(start_date="20220101", end_date="20230101", fields=["trade_date","ggt_ss","ggt_sz","hgt","sgt","north_money","south_money"])'
)
atomic_api["output_first_and_last_row"] = df_sample_str
atomic_api["Column_name"] = str(columns_dict)
...
atomic_api["example_input"] = (
    'pro.index_member(index_code= "850531.SI ", fields=["index_code","con_code","in_date","out_date","is_new","index_name","con_name"])'
)
atomic_api["output_first_and_last_row"] = df_sample_str
atomic_api["Column_name"] = str(columns_dict)
...
df = pro.index_classify(
    level="L1", src="SW2021", fields=["index_code", "industry_name", "level"]
)
...
atomic_api["example_input"] = (
    'pro.index_classify(level=\'L1\', src=\'SW2021\',filter=["index_code","industry_name","level"])'
)
atomic_api["output_first_and_last_row"] = df_sample_str
atomic_api["Column_name"] = str(columns_dict)
...
df_stock_basic_sample_str = df_stock_basic.iloc[0, :].to_string(
...
atomic_api["example_input"] = (
    'pro.stock_basic(ts_code="", name="贵州茅台", fields = ["ts_code","name","area","industry","market","list_date"])'
)
...
df_adj_factor_sample_str = df_adj_factor.iloc[[0, -1], :].to_string(
    header=False, index=False
)
...
atomic_api["example_input"] = (
    "pro.adj_factor(ts_code='000001.SZ',start_date='20180718',end_date='20190718', fields=[\"ts_code\",\"trade_date\",\"adj_factor\"])"
)
...
df_monthly = pro.monthly(
    ts_code="000001.SZ", start_date="20180101", end_date="20181101"
)
...
atomic_api["example_input"] = (
    "pro.index_daily(ts_code='399300.SZ', start_date='20180101', end_date='20191010')"
)
atomic_api["output_first_and_last_row"] = df_sample_str
atomic_api["Column_name"] = str(columns_dict)
...
atomic_api["example_input"] = (
    "pro.index_weekly(ts_code='399300.SZ', start_date='20180101', end_date='20191010')"
)
atomic_api["output_first_and_last_row"] = df_sample_str
atomic_api["Column_name"] = str(columns_dict)
...
atomic_api["example_input"] = (
    "pro.index_monthly(ts_code='399300.SZ', start_date='20180101', end_date='20191010')"
)
atomic_api["output_first_and_last_row"] = df_sample_str
atomic_api["Column_name"] = str(columns_dict)
...
atomic_api["example_input"] = (
    "pro.index_basic(name = '沪深300', fields=['ts_code','name'])"
)
atomic_api["output_first_and_last_row"] = df_sample_str
atomic_api["Column_name"] = str(columns_dict)
...
atomic_api["example_input"] = (
    "pro.index_weight(index_code='399300.SZ',start_date='20210101',end_date='20220101', fields=['index_code','con_code','trade_date','weight'])"
)
atomic_api["output_first_and_last_row"] = df_sample_str
atomic_api["Column_name"] = str(columns_dict)
